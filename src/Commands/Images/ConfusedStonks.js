...
const run = async (client, message, args) => {
	let img = await new e.ConfusedStonk().getImage(
	...
	let img2 = await new e.ConfusedStonk().getImage(
...
exports.run = run;
exports.name = 'confusedstonks';
exports.category = 'Image';
exports.cooldown = 5000;
exports.description = 'Get a Confused Stonks Image';
exports.usage = 'confusedstonks <mention or id>';
exports.aliases = ['cstonks'];
//# sourceMappingURL=ConfusedStonks.js.map
