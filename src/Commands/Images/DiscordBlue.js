...
const run = async (client, message, args) => {
	let img = await new e.DiscordBlue().getImage(
	...
	let img2 = await new e.DiscordBlue().getImage(
...
exports.run = run;
exports.name = 'discordblue';
exports.category = 'Image';
exports.cooldown = 5000;
exports.description = "Get Your Avatar In Clyde's Form (Blue)";
exports.usage = 'discordblue <mention or id>';
exports.aliases = ['dblue'];
//# sourceMappingURL=DiscordBlue.js.map
